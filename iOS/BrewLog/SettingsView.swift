...
struct SettingsView: View {
    ...
    @AppStorage("brewlog_notify_enabled") private var notifyEnabled: Bool = true
    @AppStorage("brewlog_favorites_only") private var favoritesOnly: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/brewlog-app/privacy.html")!)
